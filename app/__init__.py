...
from app.models.config import load_rate_limit_config
...
# Rate limiter settings for /search and /autocomplete (server-side only)
app.config.update(load_rate_limit_config())
